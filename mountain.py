...
Emission Probabilty : It is the edge strength normalised over the column.(Assigning higher rows with more probability is misleading, so i have used uniform proir probability)
...
In MCMC we define the probability based on edge strenght and the transition from next column and previous column. 
